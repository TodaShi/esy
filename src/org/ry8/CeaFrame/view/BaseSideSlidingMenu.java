...
import org.ry8.CeaFrame.Utils.ScreenUtils;
 ...
 * 
 */
public class BaseSideSlidingMenu extends HorizontalScrollView
{
	/**
	 * 菜单的宽度
	 */
	...
	public BaseSideSlidingMenu(Context context, AttributeSet attrs)
	{
	...
	public BaseSideSlidingMenu(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
		mScreenWidth = ScreenUtils.getScreenWidth(context);

		TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
				R.styleable.BaseSideSlidingMenu, defStyle, 0);
		...
		for (int i = 0; i < n; i++)
		{
			...
			switch (attr)
			{
			case R.styleable.BaseSideSlidingMenu_rightPadding:
				// 默认50
	...
	public BaseSideSlidingMenu(Context context)
	{
		this(context, null, 0);
	}
