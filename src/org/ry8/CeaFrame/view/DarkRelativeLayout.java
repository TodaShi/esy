...
public class DarkRelativeLayout extends RelativeLayout {  
    ...
    public DarkRelativeLayout(Context context) {  
        super(context);  
        setListener();  
    }  
      
    public DarkRelativeLayout(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        setListener();  
    }  
    ...
    private void setDrawableGrap() {  
            ...
            Bitmap newBitmap = Bitmap.createBitmap(array,w,h,Bitmap.Config.ARGB_8888);  
