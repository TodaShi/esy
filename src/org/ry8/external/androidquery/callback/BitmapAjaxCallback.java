...
import org.ry8.external.androidquery.util.BitmapCache;
import org.ry8.external.androidquery.util.Common;
import org.ry8.external.androidquery.util.RatioDrawable;
...
public class BitmapAjaxCallback extends AbstractAjaxCallback<Bitmap, BitmapAjaxCallback>{
    ...
    public BitmapAjaxCallback requestCode(String requestCode){
	...
	public void async(Context context){
		...
		if(bm != null){		
			v.setTag(AQuery.TAG_URL, url);
			status = new AjaxStatus(requestCode,null).source(AjaxStatus.MEMORY).done();
