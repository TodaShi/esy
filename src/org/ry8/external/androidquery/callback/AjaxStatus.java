...
//	}
    ...
    public AjaxStatus(String requestCode,Object tag){
        this.requestCode=requestCode;
        this.tag=tag;
    }
	
	public AjaxStatus(int code, String message,String requestCode,Object tag){
		this.code = code;
    ...
    public AjaxStatus requestCode(String requestCode){
        this.requestCode = requestCode;
        return this;
    }
