...
import org.ry8.external.HorizontalVariableListView.utils.ReflectionUtils;
import org.ry8.external.HorizontalVariableListView.utils.ReflectionUtils.ReflectionException;
import org.ry8.external.HorizontalVariableListView.widget.IFlingRunnable.FlingRunnableView;
...
public class HorizontalVariableListView extends HorizontalListView implements OnGestureListener, FlingRunnableView {
	...
	public void forceChildLayout( View child, LayoutParams params ) {
		int childHeightSpec = getChildMeasureSpec( mHeightMeasureSpec, getPaddingTop() + getPaddingBottom(),
				params.height );
		int childWidthSpec = getChildMeasureSpec( mWidthMeasureSpec, getPaddingLeft() + getPaddingRight(), params.width );
