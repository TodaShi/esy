...
public class CalendarView extends LinearLayout {
  ...
  private Context context;
    public boolean pIsMustSelected=true;
  ...
  public void updateCellViews(MonthDescriptor month, List<List<MonthCellDescriptor>> cells) {
    ...
    private boolean doSingleSelectDate(final MonthCellDescriptor cell) {
    	...
    	if (!pIsMustSelected&& selectedCals.size() > 0 && containsDate(selectedCals, newlySelCal)) {
        	clearOldSelections();
	...
	/**
	   ...
	   * notified.
	   *
	   * @see #setOnDateSelectedListener(org.ry8.View.Calendar.CalendarView.OnDateSelectedListener)
	   */
	   ...
	   *
	   * @see #setOnInvalidDateSelectedListener(org.ry8.View.Calendar.CalendarView.OnInvalidDateSelectedListener)
	   */
